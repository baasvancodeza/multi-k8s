...
kubectl set image deploymentis/client-deployment client=baasvancodeza/multi-client:$SHA
kubectl set image deploymentis/worker-deployment worker=baasvancodeza/multi-worker:$SHA
